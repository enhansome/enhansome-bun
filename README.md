...
* [Examples](https://github.com/oven-sh/bun/tree/main/examples) ⭐ 95,408 | 🐛 7,798 | 🌐 Rust | 📅 2026-08-13
...
* [Hono](https://github.com/honojs/hono) ⭐ 31,654 | 🐛 359 | 🌐 TypeScript | 📅 2026-08-13 - Ultrafast web framework for Cloudflare Workers, Deno, and Bun. Fast, but not only fast.
* [Elysia](https://github.com/elysiajs/elysia) ⭐ 18,893 | 🐛 365 | 🌐 TypeScript | 📅 2026-08-13 - Fast, and friendly Bun web framework.
* [GraphQL Yoga](https://github.com/dotansimha/graphql-yoga) ⭐ 8,531 | 🐛 161 | 🌐 TypeScript | 📅 2026-08-13 - A fast, fully featured GraphQL Framework that [runs on Bun](https://the-guild.dev/graphql/yoga-server/v3/integrations/integration-with-bun), Cloudflare Workers, Deno, and any JS environment.
...
* [GraphQL Mesh](https://github.com/urigo/graphql-mesh) ⭐ 3,512 | 🐛 209 | 🌐 TypeScript | 📅 2026-08-13 - Gateway that takes any source API and exposes GraphQL. Runs on Bun, Cloudflare Workers, Deno, and any JS environment.
...
* [Orama](https://github.com/oramasearch/orama) ⭐ 10,516 | 🐛 21 | 🌐 TypeScript | 📅 2026-08-04 - 🌌 Fast, in-memory, typo-tolerant, full-text search engine written in TypeScript.
...
* [Bun HTTP Framework Benchmark](https://github.com/SaltyAom/bun-http-framework-benchmark) ⭐ 561 | 🐛 30 | 🌐 TypeScript | 📅 2026-08-12 - Compare throughput benchmark from various Bun HTTP frameworks.
