...
* [Examples](https://github.com/oven-sh/bun/tree/main/examples) ⭐ 95,396 | 🐛 8,089 | 🌐 Rust | 📅 2026-08-13
...
* [Nixpacks Bun web server](https://github.com/railwayapp/nixpacks/tree/main/examples/node-bun-web-server) ⭐ 3,547 | 🐛 99 | 🌐 Rust | 📅 2026-08-13
* [Extro - open source browser extension starter kit](https://github.com/turbostarter/extro) ⭐ 399 | 🐛 0 | 🌐 TypeScript | 📅 2026-07-26
...
* [DBest Stack](https://github.com/itsyoboieltr/dbest-stack) ⭐ 102 | 🐛 0 | 🌐 TypeScript | 📅 2024-08-25
...
* [🐵 Xmonkey Userscript: Bun + TypeScript Boilerplate](https://github.com/genzj/bun-ts-userscript-starter) ⭐ 24 | 🐛 0 | 🌐 TypeScript | 📅 2024-10-04
...
* [Bun on Railway - Starter](https://github.com/FarazPatankar/bun-on-railway) ⭐ 7 | 🐛 0 | 🌐 Dockerfile | 📅 2022-07-06
* [react-nostalgia-boilerplate](https://github.com/boilertowns/react-nostalgia-boilerplate) ⭐ 5 | 🐛 3 | 🌐 TypeScript | 📅 2023-05-02
* [React Bun Template for Gitpod](https://github.com/Joshuafrankle/bun-react) ⭐ 3 | 🐛 0 | 🌐 HTML | 📅 2022-07-09

## Extensions

### Frameworks

* [Hono](https://github.com/honojs/hono) ⭐ 31,653 | 🐛 360 | 🌐 TypeScript | 📅 2026-08-13 - Ultrafast web framework for Cloudflare Workers, Deno, and Bun. Fast, but not only fast.
* [Elysia](https://github.com/elysiajs/elysia) ⭐ 18,887 | 🐛 366 | 🌐 TypeScript | 📅 2026-08-12 - Fast, and friendly Bun web framework.
* [GraphQL Yoga](https://github.com/dotansimha/graphql-yoga) ⭐ 8,531 | 🐛 162 | 🌐 TypeScript | 📅 2026-08-12 - A fast, fully featured GraphQL Framework that [runs on Bun](https://the-guild.dev/graphql/yoga-server/v3/integrations/integration-with-bun), Cloudflare Workers, Deno, and any JS environment.
* [Brisa](https://github.com/brisa-build/brisa) ⭐ 783 | 🐛 55 | 🌐 TypeScript | 📅 2026-05-01 A full-stack web framework with Server Actions and Web Components with JSX + signals
...
* [GraphQL Mesh](https://github.com/urigo/graphql-mesh) ⭐ 3,512 | 🐛 224 | 🌐 TypeScript | 📅 2026-08-13 - Gateway that takes any source API and exposes GraphQL. Runs on Bun, Cloudflare Workers, Deno, and any JS environment.
...
* [Fluxify](https://github.com/simylein/fluxify) ⭐ 45 | 🐛 0 | 🌐 TypeScript | 📅 2024-09-08 - A neat little library powered by Bun for building apis.
...
* [Orama](https://github.com/oramasearch/orama) ⭐ 10,515 | 🐛 21 | 🌐 TypeScript | 📅 2026-08-04 - 🌌 Fast, in-memory, typo-tolerant, full-text search engine written in TypeScript.
* [blipgloss](https://github.com/wobsoriano/blipgloss) ⭐ 212 | 🐛 1 | 🌐 TypeScript | 📅 2025-07-05 - Style definitions for nice terminal layouts 👄.
* [bun-promptx](https://github.com/wobsoriano/bun-promptx) ⭐ 147 | 🐛 5 | 🌐 Go | 📅 2023-09-19 - Terminal prompt library based on bubbles via bun:ffi.
...
* [bun-html-live-reload](https://github.com/aabccd021/bun-html-live-reload) ⭐ 44 | 🐛 1 | 🌐 Nix | 📅 2025-12-10 - Automatically reload html when Bun server hot reloads.
* [postgres-bun](https://github.com/lawrencecchen/postgres-bun) ⭐ 32 | 🐛 1 | 🌐 TypeScript | 📅 2022-10-05 - fast postgres bindings for bun runtime (libpq ffi)
...
* [Bum](https://github.com/owenizedd/bum) ⭐ 260 | 🐛 16 | 🌐 Rust | 📅 2026-06-27 - A fast Bun version manager written in Rust.
...
* [bun-discord-bot(serverless)](https://github.com/xHyroM/bun-discord-bot) ⭐ 40 | 🐛 1 | 🌐 TypeScript | 📅 2025-11-09 - Official serverless discord bot for bun discord server.
* [Shumai](https://github.com/AltriusRS/Shumai) ⭐ 29 | 🐛 0 | 🌐 TypeScript | 📅 2022-07-12 - A delicious new outlook on command line argument handling with Bun.
...
* [Bun HTTP Framework Benchmark](https://github.com/SaltyAom/bun-http-framework-benchmark) ⭐ 561 | 🐛 29 | 🌐 TypeScript | 📅 2026-08-12 - Compare throughput benchmark from various Bun HTTP frameworks.
